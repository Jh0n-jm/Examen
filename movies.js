    ...
    movieItem.innerHTML = `
      ...
      <div class="movie-info">
        ...
        <div class="movie-details">
          <span class="price">${pelicula.price}</span>
          <span class="category">${pelicula.category}</span>
...
function mostrarDetallesPelicula(peliculaId) {
  ...
  document.getElementById("modalCity").textContent = pelicula.city;
  document.getElementById("modalArea").textContent = pelicula.area;
  document.getElementById("modalPrice").textContent = pelicula.price;
